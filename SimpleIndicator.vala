/*
 * Copyright (c) 2020 Atsuya Takagi
 *
 ...
 */
public class Simple.Indicator : Wingpanel.Indicator {
    ...
    public Indicator () {
        ...
        Object (
            code_name : "simple-indicator" /* Unique name */
        );
    }
...
public Wingpanel.Indicator? get_indicator (Module module, Wingpanel.IndicatorManager.ServerType server_type) {
    ...
    debug ("Activating Simple Indicator");

    /* Check which server has loaded the plugin */
    if (server_type != Wingpanel.IndicatorManager.ServerType.SESSION) {
        /* We want to display our simple indicator only in the "normal" session, not on the login screen, so stop here! */
        return null;
    }

    /* Create the indicator */
    var indicator = new Simple.Indicator ();
